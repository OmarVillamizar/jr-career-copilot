...
def _build_prompt(profile: dict, job_description: str, lang: str) -> str:
    ...
    return (
        ...
        "5. Integrate keywords naturally into achievements. Never create bullet points that are just keyword lists. "
        "Keyword relevance matters, not keyword density.\n"
        "\n"
        "--- TENSE & ORDER RULES ---\n"
        "1. Use PRESENT tense for ongoing/current roles and education (e.g., 'I am studying...', 'I lead...').\n"
        "2. Use PAST tense for completed roles, projects, and achievements (e.g., 'I developed...', 'I built...').\n"
        "3. List experiences and projects in REVERSE-CHRONOLOGICAL order (most recent first).\n"
        "\n"
